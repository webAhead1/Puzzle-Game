...
export const pic1EasyData = [
  ...
  `${path}/Pic1-Easy/4.jpg`,
  `${path}/Pic1-Easy/5.jpg`,
  `${path}/Pic1-Easy/6.jpg`,
  `${path}/Pic1-Easy/7.jpg`,
  `${path}/Pic1-Easy/8.jpg`,
  `${path}/Pic1-Easy/9.jpg`,
];

export const pic1EasySolution = [
  `${path}/Pic1-Easy/9.jpg`,
  `${path}/Pic1-Easy/8.jpg`,
  `${path}/Pic1-Easy/7.jpg`,
  `${path}/Pic1-Easy/6.jpg`,
...
export const pic2EasyData = [
  ...
  `${path}/Pic2-Easy/4.jpg`,
  `${path}/Pic2-Easy/5.jpg`,
  `${path}/Pic2-Easy/6.jpg`,
  `${path}/Pic2-Easy/7.jpg`,
  `${path}/Pic2-Easy/8.jpg`,
  `${path}/Pic2-Easy/9.jpg`,
];

export const pic2EasySolution = [
  `${path}/Pic2-Easy/9.jpg`,
  `${path}/Pic2-Easy/8.jpg`,
  `${path}/Pic2-Easy/7.jpg`,
  `${path}/Pic2-Easy/6.jpg`,
...
export const pic3EasyData = [
  ...
  `${path}/Pic3-Easy/4.jpg`,
  `${path}/Pic3-Easy/5.jpg`,
  `${path}/Pic3-Easy/6.jpg`,
  `${path}/Pic3-Easy/7.jpg`,
  `${path}/Pic3-Easy/8.jpg`,
  `${path}/Pic3-Easy/9.jpg`,
];

export const pic3EasySolution = [
  `${path}/Pic3-Easy/9.jpg`,
  `${path}/Pic3-Easy/8.jpg`,
  `${path}/Pic3-Easy/7.jpg`,
  `${path}/Pic3-Easy/6.jpg`,
